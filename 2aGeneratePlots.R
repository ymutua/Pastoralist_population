...
# Load data
agroPoly_0 <- vect(paste0(resultsdir, "/agropastoral_countries_0.shp"))
pastoralPoly_0 <- vect(paste0(resultsdir, "/pastoral_countries_0.shp"))
agroPoly_1 <- vect(paste0(resultsdir, "/agropastoral_countries_1.shp"))
pastoralPoly_1 <- vect(paste0(resultsdir, "/pastoral_countries_1.shp"))
...
ggsave(paste0(resultsdir, "/pastoral_countries_combined.png"), p1_combined, width = 16, height = 8, dpi = 300)
...
ggsave(paste0(resultsdir, "/pastoral_admin1_combined.png"), p2_combined, width = 16, height = 8, dpi = 300)
